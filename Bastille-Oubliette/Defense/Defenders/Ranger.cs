...
public class Ranger : Defender
{
    public static Ranger instance;

    private const string PROJECTILE_CONTAINER_NAME = "ProjectileContainer";

    [SerializeField] private GameObject woodArrow = null;
    [SerializeField] private GameObject arrowPosition = null;
    ...
    {
        GameObject newArrow = Instantiate(woodArrow, arrowPosition.transform.position, transform.rotation) as GameObject;
        newArrow.transform.parent = projectileContainer.transform;
    }
}
